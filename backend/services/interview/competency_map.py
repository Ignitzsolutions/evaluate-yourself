...
_TAG_TO_COMPETENCY: Dict[str, str] = {
    ...
    "prioritization": "problem_solving",
    "strategy": "problem_solving",
    "risk": "problem_solving",
    "constraints": "problem_solving",
    "experimentation": "problem_solving",
    # technical_depth
    ...
    "db": "technical_depth",
    "scaling": "technical_depth",
    "distributed": "technical_depth",
    "distributed-systems": "technical_depth",
    "cache": "technical_depth",
    "queue": "technical_depth",
    "storage": "technical_depth",
    "sharding": "technical_depth",
    "indexes": "technical_depth",
    "migrations": "technical_depth",
    "schema-evolution": "technical_depth",
    "acid": "technical_depth",
    "isolation": "technical_depth",
    "locking": "technical_depth",
    "networking": "technical_depth",
    "http": "technical_depth",
    "rest": "technical_depth",
    "apis": "technical_depth",
    "auth": "technical_depth",
    "authorization": "technical_depth",
    "tokens": "technical_depth",
    "secrets": "technical_depth",
    "observability": "technical_depth",
    "tracing": "technical_depth",
    "metrics": "technical_depth",
    "streaming": "technical_depth",
    "realtime": "technical_depth",
    "websocket": "technical_depth",
    "messaging": "technical_depth",
    "pipeline": "technical_depth",
    "mlops": "technical_depth",
    "recsys": "technical_depth",
    "search": "technical_depth",
    "ops": "technical_depth",
    "tech": "technical_depth",
    "reliability": "technical_depth",
    "availability": "technical_depth",
    "consistency": "technical_depth",
    "idempotency": "technical_depth",
    "backpressure": "technical_depth",
    "rate-limiting": "technical_depth",
    "service-mesh": "technical_depth",
    "feature-flags": "technical_depth",
    "rollout": "technical_depth",
    "dr": "technical_depth",
    "multi-region": "technical_depth",
    "global": "technical_depth",
    "capacity": "technical_depth",
    "stats": "technical_depth",
    "timeseries": "technical_depth",
    "pagination": "technical_depth",
    # ownership
    "ownership": "ownership",
