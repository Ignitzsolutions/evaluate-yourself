...
class CandidateProfileV2(Base):
    ...
    target_interview_format = Column(String, nullable=True)
    target_job_description = Column(Text, nullable=True)
    target_job_url = Column(String, nullable=True)
    resume_url = Column(String, nullable=True)
    linkedin_url = Column(String, nullable=True)
    github_url = Column(String, nullable=True)
    portfolio_url = Column(String, nullable=True)
    resume_text = Column(Text, nullable=True)
    resume_draft_json = Column(Text, nullable=True)
    baseline_capture_json = Column(Text, nullable=True)
    consent_data_use = Column(Boolean, nullable=False, default=False)
