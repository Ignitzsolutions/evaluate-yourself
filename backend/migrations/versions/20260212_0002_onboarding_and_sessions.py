...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_user_profiles_clerk_user_id", "user_profiles", ["clerk_user_id"], unique=True
    )
    ...
    op.create_index(
        "ix_interview_sessions_session_id", "interview_sessions", ["session_id"], unique=True
    )
    op.create_index(
        "ix_interview_sessions_clerk_user_id", "interview_sessions", ["clerk_user_id"], unique=False
    )
    op.create_index(
        "ix_interview_sessions_report_id", "interview_sessions", ["report_id"], unique=False
    )
