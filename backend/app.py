...
try:
    ...
    logging.exception("Could not register required realtime router")
    raise RuntimeError("Required realtime router registration failed") from e
...
try:
    ...
    logging.exception("Could not register required health router")
    raise RuntimeError("Required health router registration failed") from e
...
try:
    ...
    logging.exception("Could not register required auth router")
    raise RuntimeError("Required auth router registration failed") from e
...
try:
    ...
    logging.exception("Could not register required admin router")
    raise RuntimeError("Required admin router registration failed") from e
...
async def adaptive_turn(
    ...
    """Compatibility wrapper for clients migrating to /next-turn."""
    return _plan_next_turn_response(
        session_id=session_id,
        payload=payload,
        current_user=current_user,
